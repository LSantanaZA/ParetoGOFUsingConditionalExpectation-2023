...
SimFromDist <- function(DistNum,n){
  # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  # Pareto
  if (DistNum == 1){ X = rpareto(n,2) ; nm="P(2)" }
  else if (DistNum == 2){ X = rpareto(n,4) ; nm="P(4)" }
  else if (DistNum == 3){ X = rpareto(n,8) ; nm="P(8)"  }
  else if (DistNum == 4){ X = rpareto(n,10); nm="P(10)"  }
  # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  # Gamma
  else if (DistNum == 5){ X = rgamma(n,0.4)+1 ; nm="G(0.4)"}
  ...
  else if (DistNum == 8){ X = rgamma(n,1.3)+1 ; nm="G(1.3)"}
  # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  # Weibull
  else if (DistNum ==  9){ X = rweibull(n,0.4)+1 ; nm="W(0.4)" }
  ...
  else if (DistNum == 15){ X = rlnorm(n,0,1.6)+1; nm = "LN(0,1.6)" }
  ...
  else if (DistNum == 21){ X = rLFR(n,0.3)+1 ; nm = "LFR(0.3)"}
  else if (DistNum == 22){ X = rLFR(n,0.6)+1 ; nm = "LFR(0.6)"}
  else if (DistNum == 23){ X = rLFR(n,0.9)+1 ; nm = "LFR(0.9)"}
  else if (DistNum == 24){ X = rLFR(n,1.2)+1 ; nm = "LFR(1.2)"}
  # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  # Beta-exponential
 ...
 # else if (DistNum == 36){ X = rDhillon(n,0.8)+1 ; nm = "DH(0.8)"}
  # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  # Log Weibull
  else if (DistNum == 33){ X = exp((-log(1-runif(n)))^(1/(0.2+1))) ; nm = "LW(0.2)"}
  else if (DistNum == 34){ X = exp((-log(1-runif(n)))^(1/(0.4+1))) ; nm = "LW(0.4)"}
  else if (DistNum == 35){ X = exp((-log(1-runif(n)))^(1/(0.6+1))) ; nm = "LW(0.6)"}
  else if (DistNum == 36){ X = exp((-log(1-runif(n)))^(1/(0.8+1))) ; nm = "LW(0.8)"}
  # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  # Benini
  else if (DistNum == 37){ X = exp((-1+sqrt(1-4*0.2*log(1-runif(n))))/(2*0.2)) ; nm = "BN(0.2)"}
  else if (DistNum == 38){ X = exp((-1+sqrt(1-4*0.4*log(1-runif(n))))/(2*0.4)) ; nm = "BN(0.4)"}
  else if (DistNum == 39){ X = exp((-1+sqrt(1-4*0.6*log(1-runif(n))))/(2*0.6)) ; nm = "BN(0.6)"}
  else if (DistNum == 40){ X = exp((-1+sqrt(1-4*0.8*log(1-runif(n))))/(2*0.8)) ; nm = "BN(0.8)"}
  # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
